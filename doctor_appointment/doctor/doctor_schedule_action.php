...
if(isset($_POST["action"]))
{
	if($_POST["action"] == 'fetch')
	{
		...
		{
			$order_column = array('doctor_database.doctor_name', 'doctor_schedule_table.doctor_schedule_date', 'doctor_schedule_table.doctor_schedule_day', 'doctor_schedule_table.doctor_schedule_start_time', 'doctor_schedule_table.doctor_schedule_end_time', 'doctor_schedule_table.average_consulting_time');
			$main_query = "
