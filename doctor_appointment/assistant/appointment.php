                ...
                <div class="row d-flex justify-content-center">
                    <div class="">
                        <div class="row input-daterange">
                            ...
                            <div class="col-md-5">
                                <input type="text" name="start_date" id="start_date" class="form-control form-control-sm" placeholder="Choose Date..." readonly />
                            </div>
                            <h6 class="font-weight-bold"> To </h6>
                            <div class="col-md-5">
                                <input type="text" name="end_date" id="end_date" class="form-control form-control-sm" placeholder="Choose Date..." readonly />
                            </div>
                        </div>
                    </div>
                    <div class="">
