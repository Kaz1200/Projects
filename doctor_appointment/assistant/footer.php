...
<!-- Footer -->
<footer class="sticky-footer m-0 mt-5" style="background-color: rgba(223, 94, 0, 1);">
    <div class="container my-auto p-1">
        <div class="copyright text-center my-auto">
            <span class="text-white text-lg">Copyright &copy; Smile Haven <?php echo date('Y'); ?></span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
